...
// Validate checks the field values on PermissionApiResource with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *PermissionApiResource) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PermissionApiResource with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// PermissionApiResourceMultiError, or nil if none found.
func (m *PermissionApiResource) ValidateAll() error {
	return m.validate(true)
}

func (m *PermissionApiResource) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return PermissionApiResourceMultiError(errors)
	}

	return nil
}

// PermissionApiResourceMultiError is an error wrapping multiple validation
// errors returned by PermissionApiResource.ValidateAll() if the designated
// constraints aren't met.
type PermissionApiResourceMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PermissionApiResourceMultiError) Error() string {
...
func (m PermissionApiResourceMultiError) AllErrors() []error { return m }

// PermissionApiResourceValidationError is the validation error returned by
// PermissionApiResource.Validate if the designated constraints aren't met.
type PermissionApiResourceValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e PermissionApiResourceValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PermissionApiResourceValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PermissionApiResourceValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PermissionApiResourceValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PermissionApiResourceValidationError) ErrorName() string {
	return "PermissionApiResourceValidationError"
}

// Error satisfies the builtin error interface
func (e PermissionApiResourceValidationError) Error() string {
	cause := ""
	if e.cause != nil {
	...
	return fmt.Sprintf(
		"invalid %sPermissionApiResource.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PermissionApiResourceValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PermissionApiResourceValidationError{}
...
func (m *Permission) validate(all bool) error {
	...
	switch v := m.Bind.(type) {
	case *Permission_ApiResourceId:
		if v == nil {
		...
		// no validation rules for ApiResourceId
	case *Permission_MenuId:
		if v == nil {
			err := PermissionValidationError{
				field:  "Bind",
				reason: "oneof value cannot be a typed-nil",
